 ...
 */
@Entity
public class TripleOAssociation extends TripleEntity implements Serializable {
    private static final long serialVersionUID = 1L;
    @ManyToOne
    private Association objet;
    ...
    public void setObjet(SemanticNode objet) {
        if (objet instanceof Association)
            this.objet = (Association)objet;
    }
