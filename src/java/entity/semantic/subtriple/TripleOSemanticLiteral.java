 ...
 */
@Entity
public class TripleOSemanticLiteral extends TripleEntity implements Serializable {
    private static final long serialVersionUID = 1L;
    @ManyToOne
    private SemanticLiteral objet;
    ...
    public void setObjet(SemanticNode objet) {
        if (objet instanceof SemanticLiteral)
            this.objet = (SemanticLiteral)objet;
    }
